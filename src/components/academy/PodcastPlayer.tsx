...
export default function PodcastPlayer({ label, src }: { label: string; src: string }) {
  ...
  return (
    <div className="academy-brand relative overflow-hidden rounded-2xl border border-cranberry/40 bg-gradient-to-br from-[#2a0a12] via-black to-[#1a1206] p-6 shadow-[0_0_40px_-10px_var(--cranberry)]">
      {/* Ambient glow */}
