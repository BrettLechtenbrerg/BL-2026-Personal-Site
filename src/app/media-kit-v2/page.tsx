...
// HIDDEN DRAFT — Media Kit v2. Identical to /media-kit except the
// "Talk & Training Topics" section, which uses the four-lane structure
// per CLAUDE_CODE_SPEC_Speaking_Page_v2.md (Section 9). noindex via layout.tsx.
...
export default function MediaKitV2Page() {
