...
// HIDDEN DRAFT — Speaking Page v3 (Best of Both Worlds).
// v2's four-lane talk structure + v1's live-action imagery (bento gallery,
// outcomes grid, testimonials) + NEW Juan Diego live speaking video clip.
...
export default function SpeakingV3Page() {
  return (
    <>
      <Header />
